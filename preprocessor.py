...
def normalize_polynomialFeatures(data_to_process, polyDegree):
    poly = preprocessing.PolynomialFeatures(degree=polyDegree, interaction_only=False, include_bias=True)
...
def apply_selected_preprocessing(selected_preprocessing, data_to_process):
    ...
    preprocessing_choices = [normalize_minMaxScaler, normalize_standardScaler, normalize_polynomialFeatures]
